# Vendored verbatim from so-vits-svc 4.1-Stable (modules/F0Predictor/RMVPEF0Predictor.py @ 730930d).
# Changes vs upstream: package-relative imports only; model_path parameterized (upstream hardcodes a cwd-relative pretrain/rmvpe.pt).
...
class RMVPEF0Predictor(F0Predictor):
    def __init__(self,hop_length=512,f0_min=50,f0_max=1100, dtype=torch.float32, device=None,sampling_rate=44100,threshold=0.05,model_path="pretrain/rmvpe.pt"):
