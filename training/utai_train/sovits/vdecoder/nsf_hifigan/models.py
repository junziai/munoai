# Vendored from so-vits-svc 4.1-Stable vdecoder/nsf_hifigan/models.py (@ 730930d).
# Generator/SineGen/Discriminator math UNCHANGED (training uses load_config for
# the STFT params + the lazy Generator for solver test-time rendering).
# Deviations: print() -> logging; load_config reads UTF-8.
import json
import logging
import os
